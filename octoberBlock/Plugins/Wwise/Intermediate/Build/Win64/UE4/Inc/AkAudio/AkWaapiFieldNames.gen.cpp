...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkWaapiFieldNames
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USAkWaapiFieldNamesConv_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USAkWaapiFieldNamesConv_Conv_FAkWaapiFieldNamesToString, "Conv_FAkWaapiFieldNamesToString" }, // 116633057
		{ &Z_Construct_UFunction_USAkWaapiFieldNamesConv_Conv_FAkWaapiFieldNamesToText, "Conv_FAkWaapiFieldNamesToText" }, // 297157732
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USAkWaapiFieldNamesConv, 1376564264);
