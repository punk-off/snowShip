...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkWaapiUri
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAkWaapiUriConv_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAkWaapiUriConv_Conv_FAkWaapiUriToString, "Conv_FAkWaapiUriToString" }, // 1948882069
		{ &Z_Construct_UFunction_UAkWaapiUriConv_Conv_FAkWaapiUriToText, "Conv_FAkWaapiUriToText" }, // 3780696018
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAkWaapiUriConv, 3689452891);
