...
#include "AkAudio/Classes/Platforms/AkPlatform_Lumin/AkLuminInitializationSettings.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAkLuminInitializationSettings_MigrateMultiCoreRendering_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/Platforms/AkPlatform_Lumin/AkLuminInitializationSettings.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAkLuminInitializationSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAkLuminInitializationSettings_MigrateMultiCoreRendering, "MigrateMultiCoreRendering" }, // 3187355935
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkLuminInitializationSettings_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Platforms/AkPlatform_Lumin/AkLuminInitializationSettings.h" },
		{ "ModuleRelativePath", "Classes/Platforms/AkPlatform_Lumin/AkLuminInitializationSettings.h" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAkLuminInitializationSettings, 1971475078);
