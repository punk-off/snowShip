...
void AkEventBasedIntegrationBehavior::FAkSDKExtrernalSourceArray_Ctor(FAkSDKExternalSourceArray* Instance, const TArray<FAkExternalSourceInfo>& BlueprintArray)
{
	if (auto* AudioDevice = FAkAudioDevice::Get())
	{
